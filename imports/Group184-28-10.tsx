...
export function MyDealzHeroImage() {
  return (
    <div className="relative bg-[#587eb2] w-full aspect-[2010/1390] max-w-full overflow-hidden" data-name="MyDealz Hero">
      {/* Linkes Bild - Detail Screen */}
      <div className="absolute h-[96.5%] left-[1.2%] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[8.6%] w-[46.0%]" data-name="Detail">
      ...
      <div className="absolute h-[97.8%] left-[51.4%] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[7.3%] w-[47.4%]" data-name="Suche">
      ...
      <div className="absolute h-[109.0%] left-[28.3%] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[-3.9%] w-[46.2%]" data-name="MyDealz_Start 1">
...
function Recherche() {
  return (
    <div className="absolute bg-[#587eb2] h-[1390px] left-0 overflow-clip top-0 w-[2010px]" data-name="Recherche">
      <div className="absolute h-[1342px] left-[25px] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[119px] w-[924px]" data-name="Detail">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgDetail} />
      </div>
      <div className="absolute h-[1360px] left-[1033px] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[101px] w-[952px]" data-name="Suche">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgSuche} />
      </div>
      <div className="absolute h-[1515px] left-[569px] shadow-[24px_14px_20.5px_0px_rgba(0,0,0,0.25)] top-[-54px] w-[928px]" data-name="MyDealz_Start 1">
